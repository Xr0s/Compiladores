...
public final class ADiferenteExpExpLogica extends PExpLogica
{
    private PExp _esq_;
    private PExp _dir_;

    public ADiferenteExpExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteExpExpLogica(
    ...
    {
        ((Analysis) sw).caseADiferenteExpExpLogica(this);
    }
