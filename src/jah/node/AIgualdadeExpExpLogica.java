...
public final class AIgualdadeExpExpLogica extends PExpLogica
{
    private PExp _esq_;
    private PExp _dir_;

    public AIgualdadeExpExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIgualdadeExpExpLogica(
    ...
    {
        ((Analysis) sw).caseAIgualdadeExpExpLogica(this);
    }
