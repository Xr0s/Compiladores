...
public interface Analysis extends Switch
{
    ...
    void caseAOuUmVarExpLogica(AOuUmVarExpLogica node);
    void caseAOuVarExpLogica(AOuVarExpLogica node);
    void caseAAndExpLogica(AAndExpLogica node);
    void caseAIgualdadeExpLogica(AIgualdadeExpLogica node);
    void caseANegExpLogica(ANegExpLogica node);
    void caseANegacaoLogicaNeg(ANegacaoLogicaNeg node);
    void caseABoolLogicaNeg(ABoolLogicaNeg node);
    void caseABoolVarLogicaNeg(ABoolVarLogicaNeg node);
    void caseANegIgLogicaNeg(ANegIgLogicaNeg node);
    void caseAIgualLogicaIgualdade(AIgualLogicaIgualdade node);
    void caseADiferenteLogicaIgualdade(ADiferenteLogicaIgualdade node);
    void caseAELogicaAnd(AELogicaAnd node);
    void caseAXorLogicaAnd(AXorLogicaAnd node);
    void caseAEUmVarLogicaAnd(AEUmVarLogicaAnd node);
    void caseAEVarLogicaAnd(AEVarLogicaAnd node);
    void caseAXorRLogicaXor(AXorRLogicaXor node);
    void caseAParenteseLogicaXor(AParenteseLogicaXor node);
    void caseAXorUmVarLogicaXor(AXorUmVarLogicaXor node);
    void caseAXorVarLogicaXor(AXorVarLogicaXor node);
