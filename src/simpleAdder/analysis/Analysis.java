...
public interface Analysis extends Switch
{
    ...
    void caseAPrioridadeFator(APrioridadeFator node);
    void caseAExpPrioridade(AExpPrioridade node);
    void caseAValorPrioridade(AValorPrioridade node);
    void caseAPrioridade(APrioridade node);
