...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTNInteiroReservada(@SuppressWarnings("unused") TNInteiroReservada node)
    {
        this.index = 27;
    }

    @Override
    public void caseTNRealReservada(@SuppressWarnings("unused") TNRealReservada node)
    {
        this.index = 28;
    }
