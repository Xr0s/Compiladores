...
public final class AUmMaiorigExpLogica extends PExpLogica
{
    private PExp _esq_;
    private PExp _dir_;

    public AUmMaiorigExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUmMaiorigExpLogica(
    ...
    {
        ((Analysis) sw).caseAUmMaiorigExpLogica(this);
    }
