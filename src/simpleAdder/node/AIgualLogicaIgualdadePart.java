...
public final class AIgualLogicaIgualdadePart extends PLogicaIgualdadePart
{
    private PExp _esq_;
    private PExp _dir_;

    public AIgualLogicaIgualdadePart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIgualLogicaIgualdadePart(
    ...
    {
        ((Analysis) sw).caseAIgualLogicaIgualdadePart(this);
    }
