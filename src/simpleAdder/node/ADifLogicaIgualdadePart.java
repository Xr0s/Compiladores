...
public final class ADifLogicaIgualdadePart extends PLogicaIgualdadePart
{
    private PExp _esq_;
    private PExp _dir_;

    public ADifLogicaIgualdadePart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADifLogicaIgualdadePart(
    ...
    {
        ((Analysis) sw).caseADifLogicaIgualdadePart(this);
    }
