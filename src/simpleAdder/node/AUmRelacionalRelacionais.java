...
public final class AUmRelacionalRelacionais extends PRelacionais
{
    private PExp _esq_;
    private POpRelacional _opRelacional_;
    private PExp _dir_;

    public AUmRelacionalRelacionais()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUmRelacionalRelacionais(
    ...
    {
        ((Analysis) sw).caseAUmRelacionalRelacionais(this);
    }
