...
public final class AUmMenorigExpLogica extends PExpLogica
{
    private PExp _esq_;
    private PExp _dir_;

    public AUmMenorigExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUmMenorigExpLogica(
    ...
    {
        ((Analysis) sw).caseAUmMenorigExpLogica(this);
    }
